...
<div class="flex min-h-screen">
    ...
    <aside class="w-64 bg-white shadow-lg fixed h-screen flex flex-col">
        <div class="p-6 border-b">
            ...
            <p class="mt-2 text-gray-600 text-sm font-medium"><?= htmlspecialchars($student_full_name) ?></p>
        </div>
        <nav class="flex-1 overflow-y-auto mt-4">
            <ul class="space-y-1">
                ...
                <li><a href="view_results.php" class="flex items-center gap-3 px-6 py-2 bg-red-100 text-red-700 font-medium">📈 Results</a></li>
            </ul>
        </nav>
