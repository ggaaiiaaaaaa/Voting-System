...
<div class="flex min-h-screen">
    <!-- SIDEBAR (copy from student_dashboard.php) -->
    <aside class="w-64 bg-white shadow-lg fixed h-screen flex flex-col">
        ...
        <nav class="flex-1 overflow-y-auto mt-4">
            <ul class="space-y-1">
                ...
                <li><a href="nominate.php" class="flex items-center gap-3 px-6 py-2 hover:bg-red-100 text-gray-700">📋 Nominations</a></li>
                <li><a href="voting.php" class="flex items-center gap-3 px-6 py-2 hover:bg-red-100 text-gray-700">🗳️ Vote</a></li>
    ...
    <main class="flex-1 ml-64 p-8">
        <header class="flex justify-between items-center mb-8">
            <div>
                <h2 class="text-2xl font-semibold text-[#D02C4D]">My Notifications</h2>
                <p class="text-sm text-gray-500">View all your notifications and updates</p>
            </div>
