    ...
    <aside class="w-64 bg-white shadow-lg fixed h-screen flex flex-col">
        ...
        <nav class="flex-1 overflow-y-auto mt-4">
            <ul class="space-y-1">
                ...
                <li><a href="notifications.php" class="flex items-center gap-3 px-6 py-2 hover:bg-[#FEEAEA] text-gray-700">🔔 Notifications</a></li>
                <li><a href="admin_profile.php" class="flex items-center gap-3 px-6 py-2 bg-[#FEEAEA] text-[#D02C4D] font-medium">👤 Profile</a></li>
            </ul>
        </nav>
