...
<div class="flex min-h-screen">
    ...
    <main class="flex-1 ml-64 p-8">
        ...
        <header class="relative z-40 flex justify-between items-center mb-8 bg-white/10 backdrop-blur-sm rounded-2xl p-6 shadow-2xl border border-white/20 animate-fade-in">
            <div>
                <h2 class="text-3xl font-bold text-white drop-shadow-lg">Edit Student</h2>
                <p class="text-sm text-gray-300 mt-1">Update the student information below.</p>
            </div>
            ...
            <form method="post" class="space-y-6">
                ...
                <div>
                    ...
                    <select name="status" class="w-full bg-white/10 border border-white/20 rounded-lg p-2 text-white placeholder-gray-400 focus:ring-2 focus:ring-blue-500 focus:outline-none">
                        <option value="Active" class="text-gray-900" <?= ($student['status'] === 'Active') ? 'selected' : '' ?>>Active</option>
                        <option value="Inactive" class="text-gray-900" <?= ($student['status'] === 'Inactive') ? 'selected' : '' ?>>Inactive</option>
                    </select>
                </div>
