...
// Logout path (all student files are in student/ folder)
...
<aside class="w-64 bg-slate-900/95 backdrop-blur-sm shadow-2xl fixed h-screen flex flex-col z-50 border-r border-white/20">
    <div class="p-6 border-b border-white/20">
        <h1 class="text-2xl font-bold text-white drop-shadow-lg">Student Panel</h1>
        ...
        <ul class="space-y-2">
            <li>
                <a href="student_dashboard.php"
                   class="flex items-center gap-3 px-6 py-3 rounded-xl hover:bg-white/10 text-white/90 hover:text-white transition-all duration-300<?= isStudentActive('student_dashboard.php') ?>">
            ...
            <li>
                <a href="nominate.php"
                   class="flex items-center gap-3 px-6 py-3 rounded-xl hover:bg-white/10 text-white/90 hover:text-white transition-all duration-300<?= isStudentActive('nominate.php') ?> <?= $canNominate ? '' : 'opacity-50 pointer-events-none' ?>">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-blue-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
            ...
            <li>
                <a href="voting.php"
                   class="flex items-center gap-3 px-6 py-3 rounded-xl hover:bg-white/10 text-white/90 hover:text-white transition-all duration-300<?= isStudentActive('voting.php') ?> <?= $canVote ? '' : 'opacity-50 pointer-events-none' ?>">
            ...
            <li>
                <a href="view_results.php"
                   class="flex items-center gap-3 px-6 py-3 rounded-xl hover:bg-white/10 text-white/90 hover:text-white transition-all duration-300<?= isStudentActive('view_results.php') ?>">
            ...
            <li>
                <a href="notifications.php"
                   class="flex items-center gap-3 px-6 py-3 rounded-xl hover:bg-white/10 text-white/90 hover:text-white transition-all duration-300<?= isStudentActive('notifications.php') ?>">
